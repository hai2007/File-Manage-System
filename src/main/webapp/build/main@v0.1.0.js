...
.bootstrap(appModule); // 监听浏览器点击了回退按钮
...
var _class = (_dec = Component({
  ...
  _createClass(_class2, [{
    ...
    value: function $mounted() {
      ...
      var page = pages[urlObj.router[0]]; // 如果未登录
...
window.__etcpack__bundleSrc__['22']=function(){
  ...
  "login": function login() {
    return window.__etcpack__getLazyBundle('./build/main@v0.1.0-bundle2.js','24');
  },
  "registry": function registry() {
    return window.__etcpack__getLazyBundle('./build/main@v0.1.0-bundle3.js','25');
  },
  "set": function set() {
    return window.__etcpack__getLazyBundle('./build/main@v0.1.0-bundle4.js','26');
  },
